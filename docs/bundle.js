...
(function () {
    ...
    function create_if_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			alpha.$$.fragment.c();
    			attr_dev(div, "class", "alpha-wrap svelte-ztrqh7");
    			add_location(div, file$5, 242, 8, 5173);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_5.name, type: "if", source: "(242:6) {#if !disableAlpha}", ctx });
    	return block;
    }
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "hsla svelte-ztrqh7");
    			attr_dev(input0, "id", "h-input");
    			input0.value = input0_value_value = Math.round(ctx.h) % 360;
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "maxlength", 3);
    			add_location(input0, file$5, 320, 12, 7630);
    			attr_dev(label0, "for", "h-input");
    			attr_dev(label0, "class", "svelte-ztrqh7");
    			add_location(label0, file$5, 328, 12, 7925);
    			attr_dev(div0, "class", "input-wrap svelte-ztrqh7");
    			add_location(div0, file$5, 319, 10, 7593);
    			attr_dev(input1, "id", "s-input");
    			attr_dev(input1, "class", "hsla percent-input svelte-ztrqh7");
    			input1.value = input1_value_value = "" + Math.round(ctx.s * 100) + "%";
    			attr_dev(input1, "type", "text");
    			attr_dev(input1, "maxlength", 4);
    			add_location(input1, file$5, 331, 12, 8020);
    			attr_dev(label1, "for", "s-input");
    			attr_dev(label1, "class", "svelte-ztrqh7");
    			add_location(label1, file$5, 340, 12, 8354);
    			attr_dev(div1, "class", "input-wrap svelte-ztrqh7");
    			add_location(div1, file$5, 330, 10, 7983);
    			attr_dev(input2, "id", "l-input");
    			attr_dev(input2, "class", "hsla percent-input svelte-ztrqh7");
    			input2.value = input2_value_value = "" + Math.round(ctx.l * 100) + "%";
    			attr_dev(input2, "type", "text");
    			attr_dev(input2, "maxlength", 4);
    			add_location(input2, file$5, 343, 12, 8449);
    			attr_dev(label2, "for", "l-input");
    			attr_dev(label2, "class", "svelte-ztrqh7");
    			add_location(label2, file$5, 352, 12, 8783);
    			attr_dev(div2, "class", "input-wrap svelte-ztrqh7");
    			add_location(div2, file$5, 342, 10, 8412);
    			attr_dev(div3, "class", "hsla-wrap svelte-ztrqh7");
    			add_location(div3, file$5, 318, 8, 7559);
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_3.name, type: "if", source: "(318:34) ", ctx });
    	return block;
    }
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "rgba svelte-ztrqh7");
    			attr_dev(input0, "type", "text");
    			input0.value = ctx.r;
    			attr_dev(input0, "maxlength", 3);
    			add_location(input0, file$5, 268, 12, 5899);
    			attr_dev(label0, "for", "red-input");
    			attr_dev(label0, "class", "svelte-ztrqh7");
    			add_location(label0, file$5, 277, 12, 6192);
    			attr_dev(div0, "class", "input-wrap svelte-ztrqh7");
    			add_location(div0, file$5, 267, 10, 5862);
    			attr_dev(input1, "id", "green-input");
    			attr_dev(input1, "class", "rgba svelte-ztrqh7");
    			attr_dev(input1, "type", "text");
    			input1.value = ctx.g;
    			attr_dev(input1, "maxlength", 3);
    			add_location(input1, file$5, 280, 12, 6289);
    			attr_dev(label1, "for", "green-input");
    			attr_dev(label1, "class", "svelte-ztrqh7");
    			add_location(label1, file$5, 289, 12, 6584);
    			attr_dev(div1, "class", "input-wrap svelte-ztrqh7");
    			add_location(div1, file$5, 279, 10, 6252);
    			attr_dev(input2, "class", "rgba svelte-ztrqh7");
    			attr_dev(input2, "id", "blue-input");
    			attr_dev(input2, "type", "text");
    			input2.value = ctx.b;
    			attr_dev(input2, "maxlength", 3);
    			add_location(input2, file$5, 292, 12, 6683);
    			attr_dev(label2, "for", "blue-input");
    			attr_dev(label2, "class", "svelte-ztrqh7");
    			add_location(label2, file$5, 300, 12, 6963);
    			attr_dev(div2, "class", "input-wrap svelte-ztrqh7");
    			add_location(div2, file$5, 291, 10, 6646);
    			attr_dev(div3, "class", "rgba-wrap svelte-ztrqh7");
    			add_location(div3, file$5, 266, 8, 5828);
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_1.name, type: "if", source: "(266:34) ", ctx });
    	return block;
    }

    // (253:6) {#if fieldsIndex === 0}
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "hex svelte-ztrqh7");
    			attr_dev(input, "type", "text");
    			input.value = ctx.hex;
    			attr_dev(input, "maxlength", 7);
    			add_location(input, file$5, 254, 10, 5457);
    			attr_dev(label, "for", "hex-input");
    			attr_dev(label, "class", "svelte-ztrqh7");
    			add_location(label, file$5, 263, 10, 5735);
    			attr_dev(div, "class", "input-wrap hex-wrap svelte-ztrqh7");
    			add_location(div, file$5, 253, 8, 5413);
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block.name, type: "if", source: "(253:6) {#if fieldsIndex === 0}", ctx });
    	return block;
    }

    // (355:10) {#if !disableAlpha}
    function create_if_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "hsla svelte-ztrqh7");
    			input.value = input_value_value = Math.round(ctx.a * 100) / 100;
    			attr_dev(input, "type", "text");
    			attr_dev(input, "maxlength", 4);
    			add_location(input, file$5, 356, 14, 8912);
    			attr_dev(label, "for", "hsla-a-input");
    			attr_dev(label, "class", "svelte-ztrqh7");
    			add_location(label, file$5, 365, 14, 9249);
    			attr_dev(div, "class", "input-wrap svelte-ztrqh7");
    			add_location(div, file$5, 355, 12, 8873);
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_4.name, type: "if", source: "(355:10) {#if !disableAlpha}", ctx });
    	return block;
    }

    // (303:10) {#if !disableAlpha}
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "rgba svelte-ztrqh7");
    			attr_dev(input, "type", "text");
    			input.value = input_value_value = Math.round(ctx.a * 100) / 100;
    			attr_dev(input, "maxlength", 4);
    			add_location(input, file$5, 304, 14, 7095);
    			attr_dev(label, "for", "alpha-input");
    			attr_dev(label, "class", "svelte-ztrqh7");
    			add_location(label, file$5, 313, 14, 7431);
    			attr_dev(div, "class", "input-wrap svelte-ztrqh7");
    			add_location(div, file$5, 303, 12, 7056);
    	...
    	dispatch_dev("SvelteRegisterBlock", { block, id: create_if_block_2.name, type: "if", source: "(303:10) {#if !disableAlpha}", ctx });
    	return block;
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 226, 2, 4615);
    			attr_dev(div1, "class", "square-wrap svelte-ztrqh7");
    			add_location(div1, file$5, 232, 4, 4903);
    			attr_dev(div2, "class", "hue-wrap");
    			add_location(div2, file$5, 237, 6, 5027);
    			attr_dev(div3, "class", "sliders svelte-ztrqh7");
    			add_location(div3, file$5, 236, 4, 4999);
    			attr_dev(div4, "class", "sliders-and-square svelte-ztrqh7");
    			add_location(div4, file$5, 230, 2, 4865);
    			attr_dev(div5, "class", "inputs-wrap svelte-ztrqh7");
    			add_location(div5, file$5, 251, 4, 5349);
    			attr_dev(div6, "class", "changer-up svelte-ztrqh7");
    			add_location(div6, file$5, 373, 6, 9419);
    			attr_dev(div7, "class", "changer-down svelte-ztrqh7");
    			add_location(div7, file$5, 374, 6, 9535);
    			attr_dev(div8, "class", "changer-wrap svelte-ztrqh7");
    			set_style(div8, "display", "none");
    			add_location(div8, file$5, 372, 4, 9363);
    			attr_dev(div9, "class", "inputs-and-changer svelte-ztrqh7");
    			add_location(div9, file$5, 249, 2, 5311);
    			attr_dev(div10, "class", "color-picker svelte-ztrqh7");
    			add_location(div10, file$5, 224, 0, 4585);
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div5 = element("div");
    			input = element("input");
    			attr_dev(div0, "class", "saturation-value-wrap svelte-1j647i4");
    			add_location(div0, file$6, 263, 8, 5827);
    			attr_dev(div1, "class", "hue-wrap");
    			add_location(div1, file$6, 269, 12, 6146);
    			attr_dev(div2, "class", "sliders svelte-1j647i4");
    			add_location(div2, file$6, 268, 8, 6112);
    			attr_dev(div3, "class", div3_class_value = "extras " + ctx.displayValue + " svelte-1j647i4");
    			add_location(div3, file$6, 262, 4, 5783);
    			attr_dev(div4, "class", "square-wrap svelte-1j647i4");
    			add_location(div4, file$6, 277, 8, 6341);
    			attr_dev(input, "id", "hex-input");
    			attr_dev(input, "class", "hex svelte-1j647i4");
    			attr_dev(input, "type", "text");
    			input.value = ctx.hex;
    			attr_dev(input, "maxlength", 7);
    			add_location(input, file$6, 283, 16, 6574);
    			attr_dev(div5, "class", "input-wrap hex-wrap svelte-1j647i4");
    			add_location(div5, file$6, 282, 12, 6524);
    			attr_dev(div6, "class", "inputs-wrap svelte-1j647i4");
    			add_location(div6, file$6, 281, 8, 6486);
    			attr_dev(div7, "class", "square-and-input svelte-1j647i4");
    			add_location(div7, file$6, 275, 4, 6301);
    			attr_dev(div8, "class", "color-picker svelte-1j647i4");
    			add_location(div8, file$6, 260, 0, 5751);
    		...
    		p: function update_1(changed, ctx) {
    			...
    			if ((!current || changed.displayValue) && div3_class_value !== (div3_class_value = "extras " + ctx.displayValue + " svelte-1j647i4")) {
    				attr_dev(div3, "class", div3_class_value);
    			}
    ...
    function instance$6($$self, $$props, $$invalidate) {
      ...
      let { startColor = "#ff0000", disableAlpha = false, upcaseOutput = false, forcePoundSign = false } = $$props;
      ...
      const update = (args, dispatch=true) => {
        ...
        $$invalidate('hex', hex = upcaseOutput ? hex.toUpperCase() : hex);
        debugger;
        dispatch && dispatchInput(hex);
      };
      ...
      update(startColor, false);
    	...
    	const writable_props = ['h', 's', 'v', 'l', 'r', 'g', 'b', 'hex', 'a', 'color', 'startColor', 'disableAlpha', 'upcaseOutput', 'forcePoundSign', 'expanded'];
    	Object.keys($$props).forEach(key => {
    	...
    	$$self.$set = $$props => {
    		...
    		if ('startColor' in $$props) $$invalidate('startColor', startColor = $$props.startColor);
    		if ('disableAlpha' in $$props) $$invalidate('disableAlpha', disableAlpha = $$props.disableAlpha);
    		if ('upcaseOutput' in $$props) $$invalidate('upcaseOutput', upcaseOutput = $$props.upcaseOutput);
    		if ('forcePoundSign' in $$props) $$invalidate('forcePoundSign', forcePoundSign = $$props.forcePoundSign);
    		if ('expanded' in $$props) $$invalidate('expanded', expanded = $$props.expanded);
    	};

    	$$self.$capture_state = () => {
    		return { h, s, v, l, r, g, b, hex, a, color, startColor, disableAlpha, upcaseOutput, forcePoundSign, fieldsIndex, expanded, displayValue };
    	};
    ...
    class ChromeSlim extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$6, create_fragment$6, safe_not_equal, ["h", "s", "v", "l", "r", "g", "b", "hex", "a", "color", "startColor", "disableAlpha", "upcaseOutput", "forcePoundSign", "expanded", "setColor"]);
    	...
    	get upcaseOutput() {
    		return this.$$.ctx.upcaseOutput;
    	}

    	set upcaseOutput(upcaseOutput) {
    		this.$set({ upcaseOutput });
    		flush();
    	}

    	get forcePoundSign() {
    		return this.$$.ctx.forcePoundSign;
    	}

    	set forcePoundSign(forcePoundSign) {
    		this.$set({ forcePoundSign });
    		flush();
    	}
...
` + "", t26, current;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h21, file$7, 142, 6, 2818);
    			attr_dev(code1, "class", "language-html svelte-8xiaml");
    			add_location(code1, file$7, 145, 8, 2854);
    			attr_dev(pre, "class", "svelte-8xiaml");
    			add_location(pre, file$7, 144, 6, 2840);
